...
import VideoPlayResource from "@/components/MoviesDetail/VideoPlayResource";
import MoviesInfo from "@/components/MoviesDetail/MoviesInfo";
import MoviesPreview from "@/components/MoviesDetail/MediaPreview";
import MagnetLinkTable from "@/components/MoviesDetail/MagnetLinkTable";
...
const Detail = () => {
  const [movieId, setMovieId] = useState<number | null>(121040);
